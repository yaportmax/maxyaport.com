...
def main() -> None:
    ...
    assert_contains(page, "handleTimelineWheel", "wheel based timeline scrubbing")
    assert_contains(page, "Math.min(720", "compact timeline rail")
    assert_contains(page, "scrollDelta * 0.006", "dampened wheel timeline speed")
    assert_contains(page, "* 0.07", "dampened drag timeline speed")
